(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__117112f7._.js",
...
"[project]/app/api/generate-doc/route.ts [app-edge-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        const { chatHistory, documentInputs, generationPrompt: customPrompt, aiProvider = "openai", aiModel = null } = body;
        if (!chatHistory || !Array.isArray(chatHistory)) {
            return new Response("Invalid chat history format", {
                status: 400
            });
        }
        if (!stepName) {
            return new Response("Step name is required", {
                status: 400
            });
        }
        ...
        const conversationHistory = chatHistory.map((msg)=>`${msg.role === "user" ? "User" : "Assistant"}: ${msg.content}`).join("\n\n");
...
Please generate the ${stepName} document now in markdown format:`;
        ...
        console.log(`Using provider: ${aiProvider}, model: ${aiModel || "default"}\n`);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$spikelog$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["spikelog"].trackApiResponseTime("generate", Date.now() - startTime);
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$spikelog$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["spikelog"].trackGenerationResult(true, stepName);
        return result.toTextStreamResponse();
    } catch (error) {
        console.error("Generate doc API error:", error);
        // Track API error (#11) and failure (#12)
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$spikelog$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["spikelog"].trackApiError("generate", error instanceof Error ? error.name : "Unknown");
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$spikelog$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["spikelog"].trackGenerationResult(false, stepName);
        return new Response(JSON.stringify({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__117112f7._.js.map